...
public class UserStatusChangedEventListener extends MasterelloEventListener<UserStatusChangedEvent> {


    private final WorkerInfoRepository workerInfoRepository;

    @Override
    protected void processEvent(UserStatusChangedEvent event) {
