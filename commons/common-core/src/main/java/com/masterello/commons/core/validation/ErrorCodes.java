...
public class ErrorCodes {
    ...
    public static final String PASSWORD_EMPTY = "error.password.empty";
    public static final String PASSWORD_LENGTH = "error.password.length";
    public static final String PASSWORD_SPECIAL_CHAR = "error.password.special-char";
    public static final String PASSWORD_DIGIT = "error.password.digit";
    public static final String PASSWORD_UPPERCASE = "error.password.uppercase";
    public static final String PASSWORD_LOWERCASE = "error.password.lowercase";

    public static final String PHONE_EMPTY = "error.phone.empty";
